...
export const FLASHCARDS: Flashcard[] = [
  ...
  { id: 'fc-conf-tcpudp', domain: '1.0', topic: 'Confusion pairs', conceptId: 'udp', front: 'TCP vs UDP — when to use each?', back: 'TCP: reliable, ordered, handshake — web, email, file transfer. UDP: fast, connectionless — voice, video, DNS, gaming. "Lost packet useless? Use UDP."' },
